...
namespace A015_Convert
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n2진수, 8진수, 10진수, 16진수로 출력하기");//for(int baseNum = 2; baseNum <= 16; baseNum*=4)
                                                              //{
            ...
            Console.WriteLine("i = {0}, {1,2}진수 = {2,16}", i, baseNum, s)baseNum = 10;
            s = Convert.ToString(value, baseNum);
            i = Convert.ToInt32(s, baseNum);
            Console.WriteLine("i = {0}, {1,2}진수 = {2,16}", i, baseNum, s);
            baseNum = 16;
            ...
            //string sNum = Convert.ToString(dNum);Console.WriteLine(@"abc\nabc");
